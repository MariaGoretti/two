...
<div class="modal">
  <br><br>
  <form class="modal-content" action="/pay" method="post">
    <div class="container">
      <center>
        <a href="/">Home</a><br>
        <a href="/view/fees">View All Payments</a><br>
        <a href="/search/fees">Search for Student</a>
      <p><strong><i><h1>Make Payment</h1></i></strong>
      Fill in this form to make payment</p>
      </center>
      <hr>
      <label for="num"><b>Student Number:</b></label>
      <input type="number" placeholder="Enter student number" name="student_no" >
      ...
      <label for="date"><b>Amount:</b></label>
      <input type="number" placeholder="Enter Amount" name="amount" >

      <input type="hidden" name=_token value="{{csrf_token()}}">
      <div class="clearfix">

        <center><button type="submit" class="signupbtn">Make Payment</button></center><br>
      </div>
    </div>
    @if ($errors->any())
    <div>
